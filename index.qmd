...
![](resources/projector-screen-outline.svg){.icon} [slides.mitchelloharawild.com/isf2025](https://slides.mitchelloharawild.com/isf2025)

![](resources/github.svg){.icon} [mitchelloharawild/talk-isf-ggtime](https://github.com/mitchelloharawild/talk-isf-ggtime)
...
::: columns
::: column
* [pandas]{.fragment .semi-fade-out fragment-index=1}
* [gluonts]{.fragment .semi-fade-out fragment-index=1}
:::
::: column
* [aeon]{.fragment .semi-fade-out fragment-index=1}
* [darts]{.fragment .semi-fade-out fragment-index=1}
:::
:::
:::
...
![](resources/tsibble.svg){.sticker-float-right .fragment .fade-in fragment-index=1}
...
::: columns
::: column
* [ts]{.fragment .semi-fade-out fragment-index=1}
* [xts]{.fragment .semi-fade-out fragment-index=1}
* [zoo]{.fragment .semi-fade-out fragment-index=1}
:::
::: column
* [lubridate]{.fragment .semi-fade-out fragment-index=1}
* tsibble
* [clock]{.fragment .semi-fade-out fragment-index=1}
:::
:::
:::
...
::: column
* Represent time
* [Data cleaning]{.fragment .semi-fade-out fragment-index=3}
* [Time slicing]{.fragment .semi-fade-out fragment-index=3}
:::
::: column
* [Missing values]{.fragment .semi-fade-out fragment-index=3}
* [Transformation]{.fragment .semi-fade-out fragment-index=3}
* [Aggregation]{.fragment .semi-fade-out fragment-index=3}
:::
:::
...
![](resources/tsibble.svg){.sticker-float-right}
...
### Timezone alignment (absolute&nbsp;/&nbsp;local time)
...
## :date: Daily seasonality in local time
